...
--
-- Host: 127.0.0.1
-- Generation Time: 2014-11-11 07:36:56
-- 服务器版本： 5.6.17
-- PHP Version: 5.5.12
...
INSERT INTO `user` (`UserID`, `UserName`, `UserPassword`, `FirstName`, `LastName`, `Email`, `artiID`) VALUES
(1, 'Jane123', 'abc', 'Jane', 'Doe', 'jane123@gmai.com', NULL),
(2, 'Jim234', 'bcd', 'Jim', 'Doe', 'jim234@gmail.com', NULL),
(3, 'Dave345', 'cde', 'Dave', 'Doe', 'dave345@gmail.com', 53);
...
--
ALTER TABLE `user`
  ADD CONSTRAINT `userarticle` FOREIGN KEY (`artiID`) REFERENCES `article` (`Arti_ID`) ON DELETE SET NULL;
